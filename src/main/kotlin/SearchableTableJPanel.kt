...
abstract class SearchableTableJPanel(
    ...
    open fun matchesConstraint(element: CatalogEntry, constraint: String, regex: Regex): Boolean = getCriteria(element).contains(regex)
    open fun matchesConstraintNoRegex(element: CatalogEntry, constraint: String): Boolean = getCriteria(element).contains(constraint)
