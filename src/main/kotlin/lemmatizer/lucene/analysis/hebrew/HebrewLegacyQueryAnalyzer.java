...
public class HebrewLegacyQueryAnalyzer extends HebrewAnalyzer {
    public HebrewLegacyQueryAnalyzer(DictHebMorph dict) {
        super(dict);
    }

    public HebrewLegacyQueryAnalyzer() throws IOException {
        super();
    }
